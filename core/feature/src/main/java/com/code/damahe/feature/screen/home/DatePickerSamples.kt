...
fun DatePickerSamples(onGoBack: () -> Unit) {
    ...
    val list = listOf(
        HomeSample("DatePickerSample") { DatePickerSample() },
        HomeSample("DatePickerWithDateSelectableDatesSample") { DatePickerWithDateSelectableDatesSample() },
        HomeSample("DateInputSample") { DateInputSample() },
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                title = { Text(text = stringResource(id = R.string.txt_Date_pickers)) },
                navigationIcon = {
