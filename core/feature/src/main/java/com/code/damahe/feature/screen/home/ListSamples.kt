...
fun ListSamples(onGoBack: () -> Unit) {
    val list = listOf(
        HomeSample("OneLineListItem") { OneLineListItem() },
        HomeSample("TwoLineListItem") { TwoLineListItem() },
        HomeSample("ThreeLineListItemWithOverlineAndSupporting") { ThreeLineListItemWithOverlineAndSupporting() },
        HomeSample("ThreeLineListItemWithExtendedSupporting") { ThreeLineListItemWithExtendedSupporting() },
    )
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                title = { Text(text = stringResource(id = R.string.txt_lists)) },
                navigationIcon = {
