...
fun FloatingActionButtonSamples(onGoBack: () -> Unit) {
    val list = listOf(
        HomeSample("ExtendedFloatingActionButton") { ExtendedFloatingActionButtonSample() },
        HomeSample("ExtendedFloatingActionButtonText") { ExtendedFloatingActionButtonTextSample() },
        HomeSample("FloatingActionButton") { FloatingActionButtonSample() },
        HomeSample("LargeFloatingActionButton") { LargeFloatingActionButtonSample() },
        HomeSample("SmallFloatingActionButton") { SmallFloatingActionButtonSample() },
    )
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                title = { Text(text = stringResource(id = R.string.txt_floating_action_buttons)) },
                navigationIcon = {
...
fun AnimatedExtendedFloatingActionButtonSample(onGoBack: () -> Unit) {
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                title = { Text(text = stringResource(id = R.string.txt_check_boxes)) },
                navigationIcon = {
                    IconButton(onClick = onGoBack) {
                        Icon(MyIcons.ArrowBack, contentDescription = "Back")
                    }
