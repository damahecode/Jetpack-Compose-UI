...
fun NavigationBarSamples(onGoBack: () -> Unit) {
    val list = listOf(
        HomeSample("NavigationBar") { NavigationBarSample() },
        HomeSample("NavigationBarWithOnlySelectedLabels") { NavigationBarWithOnlySelectedLabelsSample() },
    )
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                title = { Text(text = stringResource(id = R.string.txt_navigation_bar)) },
                navigationIcon = {
