...
fun NavigationRailSamples(onGoBack: () -> Unit) {
    val list = listOf(
        HomeSample("NavigationRail") { NavigationRailSample() },
        HomeSample("NavigationRailWithOnlySelectedLabels") { NavigationRailWithOnlySelectedLabelsSample() },
    )
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                title = { Text(text = stringResource(id = R.string.txt_navigation_rail)) },
                navigationIcon = {
