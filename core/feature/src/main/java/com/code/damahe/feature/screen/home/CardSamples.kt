...
fun CardSamples(onGoBack: () -> Unit) {
    ...
    val list = listOf(
        HomeSample("CardSample") { CardSample() },
        HomeSample("ClickableCardSample") { ClickableCardSample() },
        HomeSample("ElevatedCardSample") { ElevatedCardSample() },
        HomeSample("ClickableElevatedSample") { ClickableElevatedCardSample() },
        HomeSample("OutlineCardSample") { OutlinedCardSample() },
        HomeSample("ClickableOutlineCardSample") { ClickableOutlinedCardSample() },
    )
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                title = { Text(text = stringResource(id = R.string.txt_card)) },
                navigationIcon = {
