...
fun SegmentedButtonSamples(onGoBack: () -> Unit) {
    val list = listOf(
        HomeSample("SegmentedButtonSingleSelect") { SegmentedButtonSingleSelectSample() },
        HomeSample("SegmentedButtonMultiSelect") { SegmentedButtonMultiSelectSample() },
    )
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                title = { Text(text = stringResource(id = R.string.txt_segmented__button)) },
                navigationIcon = {
