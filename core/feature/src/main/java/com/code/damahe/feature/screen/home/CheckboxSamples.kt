...
@Composable
fun CheckboxSamples(onGoBack: () -> Unit) {

    val list = listOf(
        HomeSample("CheckboxSample") { CheckboxSample() },
        HomeSample("CheckboxWithTextSample") { CheckboxWithTextSample() },
        HomeSample("TriStateCheckboxSample") { TriStateCheckboxSample() },
    )
    ...
    Scaffold(
        ...
        Column(
            ...
            Text(
                modifier = Modifier.padding(15.dp),
                text = "Checkboxes allow the user to select one or more items from a set or turn an option on or off."
            )
            Text(
                modifier = Modifier.padding(15.dp),
                style = MaterialTheme.typography.titleMedium,
