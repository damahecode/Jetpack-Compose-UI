...
fun ChipSamples(onGoBack: () -> Unit) {
    ...
    val list = listOf(
        HomeSample("AssistChipSample") { AssistChipSample() },
        HomeSample("ElevatedAssistChipSample") { ElevatedAssistChipSample() },
        HomeSample("FilterChipSample") { FilterChipSample() },
        HomeSample("ElevatedFilterChipSample") { ElevatedFilterChipSample() },
        HomeSample("FilterChipWithLeadingIconSample") { FilterChipWithLeadingIconSample() },
        HomeSample("InputChipSample") { InputChipSample() },
        HomeSample("InputChipWithAvatarSample") { InputChipWithAvatarSample() },
        HomeSample("SuggestionChipSample") { SuggestionChipSample() },
        HomeSample("ElevatedSuggestionChipSample") { ElevatedSuggestionChipSample() },
        HomeSample("ChipGroupSingleLineSample") { ChipGroupSingleLineSample() },
        HomeSample("ChipGroupReflowSample") { ChipGroupReflowSample() },
    )
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                title = { Text(text = stringResource(id = R.string.txt_chips)) },
                navigationIcon = {
