...
fun CheckboxSamples(onGoBack: () -> Unit) {
    ...
    val list = listOf(
        ComposeSample("CheckboxSample") { CheckboxSample() },
        ComposeSample("CheckboxWithTextSample") { CheckboxWithTextSample() },
        ComposeSample("TriStateCheckboxSample") { TriStateCheckboxSample() },
    )
