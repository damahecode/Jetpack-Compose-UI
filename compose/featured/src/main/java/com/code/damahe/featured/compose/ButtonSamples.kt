...
fun ButtonSamples(onGoBack: () -> Unit) {
    ...
    val buttons = listOf(
        ComposeSample("ButtonSample") { ButtonSample() },
        ComposeSample("ElevatedButtonSample") { ElevatedButtonSample() },
        ComposeSample("FilledTonalButtonSample") { FilledTonalButtonSample() },
        ComposeSample("OutlineButtonSample") { OutlinedButtonSample() },
        ComposeSample("TextButtonSample") { TextButtonSample() },
        ComposeSample("ButtonWidthIconSample") { ButtonWithIconSample() },
    )
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                title = { Text(text = stringResource(id = R.string.buttons)) },
                navigationIcon = {
